...
class User_modeling(nn.Module):
    ...
    def __init__(self, args, user_history_dict, news_embedding_dim, user_embedding_dim, doc_feature_dict, entity_embedding, relation_embedding, adj_entity, adj_relation, entity_num, position_num, type_num):
        ...
        self.news_embedding = News_embedding(args, doc_feature_dict, entity_embedding, relation_embedding, adj_entity, adj_relation, entity_num, position_num, type_num)

        self.user_attention_layer1 = nn.Linear(news_embedding_dim, self.args.layer_dim)
        self.user_attention_layer2 = nn.Linear(self.args.layer_dim, 1)
    ...
    def forward(self, user_id):
        ...
        user_history_embedding = self.news_embedding(user_history)
